  ...
  return (
    ...
    //</div>
      ...
      <div id="container" className="main">
        <section id="section1" className="section">123123</section>
        <section id="section2" className="section">456456</section>
        <section id="section3" className="section">789789</section>
      </div>
  );
}
