  ...
  useEffect(() => {
    async function fetchDetail() {
      try {
        // 관리자 - 봉사 예약 상세 조회
        const { data } =
          await AdminReserveService.getVolunteerReservationDetail(reserveCode);
        setDetail(data);
      ...
      <div className="form_center_box">
        <div className="temp_btn white md">
          <button
            type="button"
            className="btn"
            onClick={() => navigate("/admin/reserve/volunteer")}
          >
            목록보기
          </button>
        </div>
