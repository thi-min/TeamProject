...
import "../style/LandInfoStyle.css";
import smallDogImg from "../../../contents/images/small-dog.png";
import largeDogImg from "../../../contents/images/large-dog.png";
import convenientImg from "../../../contents/images/convenient-facilities.png";

const LandInfoPage = () => {
  return (
    <div className="land-info-page">
      <div className="land-info-container">
        <h1 className="land-info-title">놀이터 소개</h1>
        <p className="land-info-description">
          반려견과 보호자가 함께 즐길 수 있는 안전하고 쾌적한 공간입니다.
          <br />
          대형견과 중/소형견으로 구분된 놀이터와 편의 시설을 통해
          반려견의 사회성과 건강을 증진시켜 보세요.
        </p>
