          ...
          <div className="row_wrap">
            <div className="item_area">
              ...
              <div className="map_wrap">
                <div className="bbs_title_box"><span>오시는길</span><a className="bbs_move_btn" href="/" data-discover="true">더보기</a></div>
                <RoughMap />
              </div>
            </div>
          </div>
            ...
            <div className="item_area animal_bbs_box">
              ...
              <div className="animal_inner">
                ...
                <div className="animal_btn_box">
                  <button type="button" className="ani_btn prev" onClick={handlePrev2}>이전</button>
                  <button type="button" className="ani_btn next" onClick={handleNext2}>다음</button>
                </div>
              </div>
            </div>
          </div>
